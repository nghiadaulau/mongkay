...
class CustomResponseCode(CustomCodeBase):
    ...
    HTTP_425 = (425, 'Too early! Please wait a moment.')
    HTTP_429 = (429, 'Too many requests! Please slow down for a second.')
...
class CustomErrorCode(CustomCodeBase):
    CAPTCHA_ERROR = (40001, 'Ops! Something went wrong')
